...
export declare class GrammarDeclaration extends Node {
    ...
    constructor(start: number, rules: readonly RuleDeclaration[], topRules: RuleDeclaration[], tokens: TokenDeclaration | null, context: ContextDeclaration | null, externalTokens: readonly ExternalTokenDeclaration[], externalSpecializers: readonly ExternalSpecializeDeclaration[], precedences: PrecDeclaration | null, mainSkip: Expression | null, scopedSkip: readonly {
        expr: Expression;
        rules: readonly RuleDeclaration[];
    }[], dialects: readonly Identifier[], grammars: readonly ExternalGrammarDeclaration[], externalProps: readonly ExternalPropDeclaration[], autoDelim: boolean);
    toString(): string;
}
...
export declare class ExternalGrammarDeclaration extends Node {
    readonly id: Identifier;
    readonly externalID: Identifier;
    readonly source: string | null;
    constructor(start: number, id: Identifier, externalID: Identifier, source: string | null);
}
...
export declare class SequenceExpression extends Expression {
    ...
    constructor(start: number, exprs: readonly Expression[], markers: readonly (readonly ConflictMarker[])[]);
    toString(): string;
